...
import {CanActivateFn, RouterModule, RouterStateSnapshot, ActivatedRouteSnapshot, Routes, Router} from '@angular/router';
...
const routes: Routes = [
  ...
  { path: 'edit-trip/:tripCode', component: EditTripComponent, pathMatch: 'full', canActivate: [authGuard]},
